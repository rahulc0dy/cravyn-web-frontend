const FoodCard = () => {
  return (
    <div class="max-w-[14.5rem] rounded-lg shadow-lg bg-white transform transition-transform hover:scale-105 hover:shadow-xl relative pt-5 overflow-visible">
      <div class="absolute -top-16 left-1/2 transform -translate-x-1/2">
        <img class="w-56 h-56 object-contain" src="/assets/images/Sandwich.png" alt="Burger" />
      </div>

      <div class="px-2 py-1 pt-20"> 
        <div class="font-bold text-xl text-center mb-1">Sandwich</div>
        ...
        <div class="flex justify-center items-center mb-2">
          ...
          <span class="text-gray-700 ml-1 text-xs">4.5</span>
        </div>

        <div class="flex items-center justify-around mb-2">
          <div class="text-sm font-semibold text-yellow-600">₹40.00</div>
          <button class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-2 px-4 rounded-full text-xs transition-colors w-1/3">
            Order Now
          </button>
