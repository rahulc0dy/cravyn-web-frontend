...
const DocumentModalBox=({
visible,func
})=> {
    if(!visible) return null;
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
      <div className="bg-white rounded-3xl shadow-lg w-full max-w-md md:max-w-lg p-6">
        ...
        <ul className="space-y-3">
          <li className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#009E60" class="size-6">
        ...
        <div className="mt-6 text-center">
          <button onClick={func} className="w-full bg-secondary-green text-white py-2 rounded-full font-semibold hover:bg-teal-900">
            Okay
          </button>
        </div>
      </div>
