    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-blue-50 md:p-4 m-4 rounded-3xl shadow-lg w-full max-w-lg min-h-[70svh]">
        ...
        <div className="flex justify-between items-center px-4 pt-4 md:py-4 border-b border-gray-200">
          ...
          <button
            onClick={close_func}
            className="text-gray-500 text-5xl md:-translate-y-8 font-extrabold hover:text-red-500"
          >
            &times;
          </button>
        </div>
        ...
        <div className="px-8 py-4 bg-white rounded-lg border-2 border-grey-medium mx-4">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 md:mb-2">
              ...
              <p className="text-wrap">177A, Bleeker Street Goabagan Road</p>
            ...
            <div>
              <Link
                href="#"
                className="text-blue-medium underline cursor-pointer flex items-center"
              >
            ...
            <div>
              <Link
                href="#"
                className="text-blue-medium flex items-center underline cursor-pointer"
              >
                <span className="material-icons text-blue-600 mr-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
