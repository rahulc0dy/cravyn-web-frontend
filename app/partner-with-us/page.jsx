  ...
  return (
    <section className="w-full">
      <div className="wrapper">
        <div className="w-full flex flex-col place-items-center text-center py-10 px-5 rounded-md bg-restaurant-hero-bg bg-cover">
          <h2 className="md:text-3xl font-bold py-8">
