...
const RegisterRestaurant=()=>{
    ...
    <div className=" wrapper grid grid-cols-1 lg:gap-y-0 lg:grid-cols-[1.7fr_3fr] lg:max-h-[78.5svh] lg:overflow-y-scroll mx-auto gap-x-10">
        <div className="lg:sticky lg:top-0 bottom-0 bg-green-800 p-4 rounded-3xl lg:rounded-b-none lg:rounded-t-3xl lg:max-h-[78.5svh]">
            ...
            <Image className="mx-auto pb-6" src="/assets/images/restaurant/restaurant-background.png" width={250} height={100}></Image>
            <p className="text-center text-white text-2xl my-auto font-bold px-2">Register with us in 10 minutes and get 0% commission for the 1st month for new restaurants in selected cities</p>
            ...
            <div className="flex bg-white my-10 rounded-full w-full justify-center p-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="green" class="size-6">
