      ...
      <AnimatePresence mode="wait">
        <div class="bg-white shadow-md rounded-lg flex flex-col xl:flex-row max-w-5xl mx-5 m-10  xl:min-h-[80svh]  min-w-[50svw]">
          <motion.div
            ...
            class="z-50 bg-login-background bg-cover xl:rounded-l-lg xl:rounded-tr-none rounded-br-none rounded-t-lg p-8 gap-4 xl:w-1/2 w-full flex flex-col items-center justify-center"
          >
            <h2 class="text-5xl font-black text-white mb-4 text-center drop-shadow">
              New here?
            </h2>
            <p class="text-white font-medium mb-6 text-2xl text-center drop-shadow">
