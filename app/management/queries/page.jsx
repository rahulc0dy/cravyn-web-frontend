...
const QueryPage = () => {
  ...
  const solvedQueries = [
    ...
    { name: 'Priya Singh', question: 'Can I cancel my order after placing it?' },
    { name: 'Rupesh Paul', question: 'Why is my order delayed?' },
    { name: 'Amit Kumar', question: 'Can I change my delivery address?' },
    { name: 'Priya Singh', question: 'What payment methods are available?' },
    { name: 'Rupesh Paul', question: 'Why is my order delayed?' },
  ...
  const queriesToShow = activeTab === 'unanswered' ? unansweredQueries : solvedQueries;
      ...
      <div className="bg-white w-full max-w-2xl rounded-lg shadow-lg">
        ...
        <div className="flex justify-around border-b border-gray-200">
          <button
            ...
            className={`flex-1 py-3 ${activeTab === 'unanswered' ? 'border-b-2 border-blue-500 text-blue-500 font-semibold' : 'text-gray-500'}`}
          >
            Unanswered Queries
          </button>
          <button
            onClick={() => setActiveTab('solved')}
            className={`flex-1 py-3 ${activeTab === 'solved' ? 'border-b-2 border-blue-500 text-blue-500 font-semibold' : 'text-gray-500'}`}
          >
            Solved Queries
          </button>
        </div>
