  ...
  <div className="bg-about-background bg-cover min-h-screen flex flex-col">
      ...
      <section className="p-8 lg:p-0 flex flex-grow items-center justify-center">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-6xl lg:text-8xl font-bold text-gray-900 mb-9">Who Are We?</h1>
          <p className="text-lg md:text-2xl md:font-normal font-semibold text-gray-600 leading-relaxed">
            We are a dynamic food delivery company dedicated to bringing your favorite meals right to your doorstep with speed and convenience. We partner with top restaurants and local eateries to offer a wide variety of cuisines, ensuring there’s something for everyone. Our mission is to create a seamless and enjoyable ordering experience, driven by our passion for great food and exceptional customer service. At Cravyn, we’re committed to connecting people with the food they love, one delivery at a time.
          </p>
        </div>
      </section>
    </div>
    ...
    <button className="bg-accent-yellow font-bold text-black rounded-full px-5 py-2 ml-14 my-6 hover:bg-yellow-500">Contact us</button>
    </div>
    <div>
      <Image className="mr-10 hidden md:inline-block" src="/assets/images/About Us/dots.svg" width={200} height={150}></Image>
    </div>
    </div>
    </div>
    </div>
